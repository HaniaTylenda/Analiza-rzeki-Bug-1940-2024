...
map.getView().fit([2347961.630939, 6892090.398919, 2350349.116547, 6894239.087897], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analiza Bug 1940-2024 HT</h2>';
        return titleElement;
    })(),
